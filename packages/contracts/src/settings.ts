...
export const ClientSettingsSchema = Schema.Struct({
  ...
  /**
   * Copy a terminal selection to the clipboard as soon as the mouse button is
   * released, instead of offering a Copy / Add to chat popup. Add to chat stays
   * available from the right-click menu.
   */
  terminalCopyOnSelect: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
});
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  terminalCopyOnSelect: Schema.optionalKey(Schema.Boolean),
});
