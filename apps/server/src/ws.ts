    ...
    Effect.gen(function* () {
      ...
      const dispatchBootstrapTurnStart = (
        ...
        Effect.gen(function* () {
          ...
          // The worktree git registered, for removal on cancel. targetWorktreePath
          // may point below it when the project is rooted in a subdirectory.
          ...
          const bootstrapProgram = Effect.gen(function* () {
            ...
            if (prepareWorktree && shouldPrepareWorktree && worktreeBaseRef) {
              ...
              createdWorktreeRoot = worktree.worktree.path;
            ...
            Effect.catchCause((cause) => {
              ...
              if (Cause.hasInterruptsOnly(cause)) {
                ...
                const removeCreatedWorktree =
                  tracked && createdWorktreeRoot && bootstrap?.prepareWorktree
